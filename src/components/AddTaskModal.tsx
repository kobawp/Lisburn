      ...
      >
        <form onSubmit={handleSubmit} className="flex-1 flex flex-col">
          ...
          <div className="p-4 sm:p-6 space-y-5 flex-1 overflow-y-auto">
            ...
            {/* Task Title */}
            <div>
              <label className="block text-[#777777] font-light text-[14px] mb-1.5" htmlFor="new-task-title-input">
            ...
            {/* Task Description */}
            <div>
              <label className="block text-[#777777] font-light text-[14px] mb-1.5" htmlFor="new-task-desc-input">
                Notes (Optional)
              </label>
              <textarea
                value={description}
